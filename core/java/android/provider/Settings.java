...
public final class Settings {
    ...
    /**
     * Activity Action: Show general information about the Android firmware
     * android version, security patch level, baseband version etc.).
     * <p>
     * In some cases, a matching Activity may not exist, so ensure you
     * safeguard against this.
     * <p>
     ...
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_DEVICE_FIRMWARE_VERSION =
        "android.settings.DEVICE_FIRMWARE_VERSION";
